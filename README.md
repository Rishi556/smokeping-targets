...
An open and community-driven project to maintain simple to use Smokeping targets with scripting to automatically generate/update your Targets file. See a [demo in action here](https://smokeping-ams-nl.eranium.net/smokeping/) or check out the automatically generated [INSTANCES.md](https://github.com/eranium/smokeping-targets/blob/main/INSTANCES.md).
...
The goal of this project is to build and maintain a standardized list of targets for our Smokepings, free to use by all network operators or network enthusiasts. The aim is to have as many locations as possible.
...
[
    {
        ...
        "location": "City",
        "category": "isp",
        "smokeping": "https://example.com/smokeping"
    }
]
```
...
| `"smokeping"` | If the network offers a smokeping, add URL here. If not, set it to `false`.                                                              |
...
| `carrier` | Provides connectivity to a network, like T1/2 operator. |
...
## Credits
The ready to go `Targets` file contains a link back to this project, as it is community-driven, it would benefit us all if people contribute.
